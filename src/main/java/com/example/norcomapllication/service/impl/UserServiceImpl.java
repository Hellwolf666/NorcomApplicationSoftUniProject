...
public class UserServiceImpl implements UserService {
    ...
    private void initializeUsers() {
        if (userRepository.count() == 0) {
            ...
            Role adminRole = roleRepository.findByRole(RoleEnumClass.ADMINISTRATOR);
            Role userRole = roleRepository.findByRole(RoleEnumClass.USER);

            User admin = new User();
            admin.setFullName("Kaloyan Adminov");
            ...
            user.setAddress("st.Stamboliiski 69");
    ...
    private void initializeRoles() {
        ...
        if (roleRepository.count() == 0) {
            ...
            adminRole.setRole(RoleEnumClass.ADMINISTRATOR);

            Role userRole = new Role();
            adminRole.setRole(RoleEnumClass.USER);
